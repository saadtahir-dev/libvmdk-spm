...
#if !defined( _LIBCNOTIFY_DEFINITIONS_H )
#define _LIBCNOTIFY_DEFINITIONS_H

#include <libcnotify/types.h>

#define LIBCNOTIFY_VERSION			20260509

/* The libcnotify version string
 */
#define LIBCNOTIFY_VERSION_STRING		"20260509"
...
#endif /* !defined( _LIBCNOTIFY_DEFINITIONS_H ) */
