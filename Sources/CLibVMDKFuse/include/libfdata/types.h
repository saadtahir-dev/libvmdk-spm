...
#if !defined( _LIBFDATA_TYPES_H )
#define _LIBFDATA_TYPES_H
...
#define __USE_UNIX98
#define LIBFDATA_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBFDATA_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBFDATA_DEFINITION_UNIX98
#endif
...
#endif /* !defined( _LIBFDATA_TYPES_H ) */
