/*
 * Type definitions for libfcache
 *
...
#if !defined( _LIBFCACHE_TYPES_H )
#define _LIBFCACHE_TYPES_H
...
#define __USE_UNIX98
#define LIBFCACHE_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBFCACHE_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBFCACHE_DEFINITION_UNIX98
#endif
...
#endif /* !defined( _LIBFCACHE_TYPES_H ) */
