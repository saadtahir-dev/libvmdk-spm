...
#if !defined( _LIBCLOCALE_DEFINITIONS_H )
#define _LIBCLOCALE_DEFINITIONS_H

#include <libclocale/types.h>

#define LIBCLOCALE_VERSION				20260509

/* The libclocale version string
 */
#define LIBCLOCALE_VERSION_STRING			"20260509"
...
#endif /* !defined( _LIBCLOCALE_DEFINITIONS_H ) */
